...
export default function IndividualsPage() {
  const { data: allContacts, isLoading } = useEngagement(200);
              ...
              <table className="w-full">
                <thead className="sticky top-0 bg-card/95 backdrop-blur-sm z-10">
                  <tr className="border-b border-border/50 text-left text-sm text-muted-foreground">
                    <th className="pb-3 pt-3 px-3 font-medium">Rank</th>
                    ...
                    <th className="pb-3 pt-3 px-3 font-medium text-right">Engagement Score</th>
                  </tr>
                </thead>
                <tbody>
